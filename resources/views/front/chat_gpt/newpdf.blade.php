...
<head>
	...
	<style>
		@page :first {background-image: url({{ asset('pdf/images/number-'.$soulNumber.'.png') }}); background-image-resize: 4; background-repeat: no-repeat; width: 100%;height: 100%; footer: html_myFooter;}
	...
	@endphp
		...
		<div class="topic_page" style="">
			<div class="main_box pdf_box" style="display: block;width: 100%;">
				...
				<div class="title_box">
					<p style="text-decoration: text-capitalization"> {{$fullName}} </p>
