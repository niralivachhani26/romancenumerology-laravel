...
<body style="background-color: #ffb6c1;">
    <div class="salesCopyWriting thankyoubg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                     <div class="thankyoupage">
                        <div class="mainlogo">
                            <img src="{{ asset('assets/front/images/soulSketchLogo.jpg')}}" alt="">
                        </div>
                        <div class="thankyoupagetitle">
                            <h1>Thank You<br>Order Completed!</h1>
                        </div>
                        <div class="statement">
                            <p>Your credit card statement will show a charge from CLKBANK*</p>
                        </div>
                        <p>For product support, please contact the vendor at support@soulsketchnumerology.com  For order support, please contact <a href="#">ClickBank</a> here</p>
                        <a href="#" class="button">Access my product Now</a>
                    </div>
                </div>
            </div>
        </div>
