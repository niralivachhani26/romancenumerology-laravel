                            ...
                            <h2>Your Soulmate Number Reading </h2>
                                ...
                                <div class="sketchSection">
                                    <div class="sketchGroup">
                                        <input type="radio" name="sketch" id="color"> 
                                        <label for="color"> <span></span> Color</label>
                                    </div>
                                    <div class="sketchGroup">
                                        <input type="radio" name="sketch" id="sketch"> 
                                        <label for="sketch"> <span></span> Color + Sketch</label>
                                    </div>
                                    <div class="sketchGroup">
                                        <input type="radio" name="sketch" id="blackWhite"> 
                                        <label for="blackWhite"> <span></span> Black & White</label>
                                    </div>
                                </div>
                            <a href="#"><span>I Want My Soulmate Number Reading Now!</span></a>
                        </div>
                    </div>
                </div>
            </div>
