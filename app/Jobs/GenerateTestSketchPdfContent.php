...
class GenerateTestSketchPdfContent implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($chapterKey, $chapterTitle, $soulmateNumber = 7)
    {
     ...
     public function handle(): void
    {
         try {
            ...
            if ($content) {
                // Save to DB
                $soulSketchPdfContent = new TestPdfContentPromt();
